            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form class="mb-8" action="{{ route('contacts.index') }}" method="get">
                        <input type="text" name="search" value="{{ $search }}" placeholder="検索" class="txt">
                        <button class="mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索する</button>
                    </form>
