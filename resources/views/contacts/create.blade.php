                  ...
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <input type="radio" name="gender" value="0" {{ old('gender')==0 ? 'checked' :'' }} class="ml-1"><span class="ms-2">男性</span>
                        <input type="radio" name="gender" value="1" {{ old('gender')==1 ? 'checked' :'' }} class="ml-4"><span class="ms-2">女性</span>
                      </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <span class="ml-2 text-sm text-gray-600">注意事項に同意する</span>
                      </div>
                    </div>
