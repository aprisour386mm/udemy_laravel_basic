                  ...
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <input type="radio" name="gender" value="0" @if ($contact->gender === 0 ) checked @endif class="ml-1"><span class="ms-2">男性</span>
                        <input type="radio" name="gender" value="0" @if ($contact->gender === 1 ) checked @endif class="ml-4"><span class="ms-2">女性</span>
                      </div>
                    </div>
